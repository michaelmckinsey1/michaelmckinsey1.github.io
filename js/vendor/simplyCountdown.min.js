    ...
    (t = function (e) {
        ...
        (s = function (e, t, n) {
            ...
            return (
                ...
                s.appendChild(a),
                o.appendChild(s),
                o.classList.add(t.sectionClass),
                o.classList.add(n),
                r.classList.add(t.amountClass),
                a.classList.add(t.wordClass),
                e.appendChild(o),
                { full: o, amount: r, word: a }
            );
        }),
        (n = function (e, t) {
            var n;
                    ...
                    (t = function () {
                        ...
                        (d = new Date()),
                            p.enableUtc
                                ...
                                : (l = (r - d.getTime()) / 1e3),
                            l > 0
                                ? ((u = parseInt(l / 86400, 10)),
                                  (l %= 86400),
                                  (c = parseInt(l / 3600, 10)),
                                  (l %= 3600),
                                  (m = parseInt(l / 60, 10)),
                                  (w = parseInt(l % 60, 10)))
                                : ((u = 0),
                            ...
                            p.inline
                                ? (e.innerHTML =
                                      ...
                                      y +
                                      ".")
                                : ((s.days.amount.textContent =
                                      (p.zeroPad && u.toString().length < 2
                                          ? "0"
                                          : "") + u),
                                  (s.days.word.textContent = t),
                                  (s.hours.amount.textContent =
                                      (p.zeroPad && c.toString().length < 2
                                          ? "0"
                                          : "") + c),
                                  (s.hours.word.textContent = n),
                                  (s.minutes.amount.textContent =
                                      (p.zeroPad && m.toString().length < 2
                                          ? "0"
                                          : "") + m),
                                  (s.minutes.word.textContent = a),
                                  (s.seconds.amount.textContent =
                                      (p.zeroPad && w.toString().length < 2
                                          ? "0"
                                          : "") + w),
                                  (s.seconds.word.textContent = y));
                    }),
                        t(),
                        (o = window.setInterval(t, p.refresh));
                });
        }),
        (e.simplyCountdown = o);
})(window),
