if (
    ((function (t, e) {
        ...
        function i(t, e, n) {
            ...
            if ("string" == typeof e) {
                if (Tt.test(e)) return ft.filter(e, t, n);
                e = ft.filter(e, t);
            }
            return ft.grep(t, function (t) {
        ...
        function r(t) {
            var e = {};
            return (
                ft.each(t.match(At) || [], function (t, n) {
                    e[n] = !0;
                }),
                e
            );
        ...
        function s() {
            nt.addEventListener
                ...
                : (nt.detachEvent("onreadystatechange", a),
            ...
            if (It(t)) {
                ...
                if (
                    ...
                    return (
                        ...
                        void 0 !== n && (r[ft.camelCase(e)] = n),
                        "string" == typeof e
                            ? null == (o = r[e]) && (o = r[ft.camelCase(e)])
                            : (o = r),
                        o
                    );
            }
            ...
            if (It(t)) {
                ...
                if (s[a]) {
                    if (e && (i = n ? s[a] : s[a].data)) {
                        ft.isArray(e)
                            ? (e = e.concat(ft.map(e, ft.camelCase)))
                            : e in i
                            ? (e = [e])
                            : ((e = ft.camelCase(e)),
                              (e = e in i ? [e] : e.split(" "))),
        ...
        function h(t, e) {
            ...
            return void 0 === e || (e && ft.nodeName(t, e))
                ? ft.merge([t], r)
                : r;
        }
        function g(t, e) {
        ...
        function v(t, e, n, i, o) {
            for (
                var r, s, a, l, c, u, d, f = t.length, v = p(e), y = [], b = 0;
                f > b;
                b++
            )
                if ((s = t[b]) || 0 === s)
                    if ("object" === ft.type(s))
                        ...
                        for (
                            l = l || v.appendChild(e.createElement("div")),
                                ...
                                d = Bt[c] || Bt._default,
                                l.innerHTML = d[1] + ft.htmlPrefilter(s) + d[2],
                                r = d[0];
                            r--;
                        ...
                        if (
                            (!ut.leadingWhitespace &&
                                Ft.test(s) &&
                                y.push(e.createTextNode(Ft.exec(s)[0])),
                            !ut.tbody)
                        )
                            for (
                                r =
                                ...
                                ft.nodeName((u = s.childNodes[r]), "tbody") &&
                                    !u.childNodes.length &&
                                    s.removeChild(u);
                        for (
                            ft.merge(y, l.childNodes), l.textContent = "";
                            l.firstChild;
            ...
            for (
                l && v.removeChild(l),
                    ut.appendChecked || ft.grep(h(y, "input"), m),
                    b = 0;
                (s = y[b++]);
        ...
        function C(t) {
            return (
                (t.type = (null !== ft.find.attr(t, "type")) + "/" + t.type), t
            );
        }
        function E(t) {
        ...
        function A(t, e, n, i) {
            ...
            if (
                g ||
                (d > 1 && "string" == typeof p && !ut.checkClone && ee.test(p))
            )
                return t.each(function (o) {
                    var r = t.eq(o);
                    g && (e[0] = p.call(this, o, r.html())), A(r, e, n, i);
                });
            if (
                d &&
                ((c = v(e, t[0].ownerDocument, !1, t, i)),
                (o = c.firstChild),
                1 === c.childNodes.length && (c = o),
                o || i)
            ) {
                for (s = (a = ft.map(h(c, "script"), C)).length; d > u; u++)
                    (r = c),
                        u !== f &&
                            ((r = ft.clone(r, !0, !0)),
                            s && ft.merge(a, h(r, "script"))),
                        n.call(t[u], r, u);
                if (s)
                    for (
                        l = a[a.length - 1].ownerDocument, ft.map(a, E), u = 0;
                        s > u;
                        u++
                    )
                        (r = a[u]),
                            Rt.test(r.type || "") &&
                                !ft._data(r, "globalEval") &&
                                ft.contains(l, r) &&
                                (r.src
                                    ? ft._evalUrl && ft._evalUrl(r.src)
                                    : ft.globalEval(
                                          (
                                              r.text ||
                                              r.textContent ||
        ...
        function N(t, e, n) {
            for (
                var i, o = e ? ft.filter(e, t) : t, r = 0;
                null != (i = o[r]);
                r++
            )
                n || 1 !== i.nodeType || ft.cleanData(h(i)),
                    i.parentNode &&
                        (n &&
                            ft.contains(i.ownerDocument, i) &&
                            g(h(i, "script")),
            ...
            return (
                n ||
                    (("none" !== (n = O(t, e)) && n) ||
                        ((re = (
                            re ||
                            ft("<iframe frameborder='0' width='0' height='0'/>")
                        ).appendTo(e.documentElement)),
                        (e = (re[0].contentWindow || re[0].contentDocument)
                            .document).write(),
                        e.close(),
                        (n = O(t, e)),
                        re.detach()),
        ...
        function L(t) {
            if (t in xe) return t;
            for (
                var e = t.charAt(0).toUpperCase() + t.slice(1), n = we.length;
                n--;
                ...
                (i = t[s]).style &&
                    ...
                    e
                        ? (r[s] || "none" !== n || (i.style.display = ""),
                          "" === i.style.display &&
                              jt(i) &&
                              (r[s] = ft._data(i, "olddisplay", I(i.nodeName))))
                        : ((o = jt(i)),
                          ((n && "none" !== n) || !o) &&
                              ft._data(
                                  i,
                                  "olddisplay",
                                  o ? n : ft.css(i, "display")
                              )));
            for (s = 0; a > s; s++)
                (i = t[s]).style &&
                    ((e &&
        ...
        function P(t, e, n, i, o) {
            for (
                ...
                "margin" === n && (s += ft.css(t, n + Pt[r], !0, o)),
                    i
                        ? ("content" === n &&
                              (s -= ft.css(t, "padding" + Pt[r], !0, o)),
                          "margin" !== n &&
                              (s -= ft.css(
                                  t,
                                  "border" + Pt[r] + "Width",
        ...
        function j(t, e, n) {
            ...
            if (0 >= o || null == o) {
                if (
                    ((0 > (o = fe(t, e, r)) || null == o) && (o = t.style[e]),
                    le.test(o))
                )
                    return o;
                (i = s && (ut.boxSizingReliable() || o === t.style[e])),
                    (o = parseFloat(o) || 0);
            }
        ...
        function q(t, e, n) {
            ...
            for (F(u, c.opts.specialEasing); s > r; r++)
                if ((i = q.prefilters[r].call(c, t, u, c.opts)))
                    return (
                        ft.isFunction(i.stop) &&
                            (ft._queueHooks(c.elem, c.opts.queue).stop =
                                ft.proxy(i.stop, i)),
                        i
                    );
            return (
                ...
                ft.fx.timer(
                    ft.extend(l, { elem: t, anim: c, queue: c.opts.queue })
                ),
                c
        ...
        (ft.fn = ft.prototype =
            ...
            ft.extend({
                ...
                camelCase: function (t) {
                    return t.replace(ht, "ms-").replace(gt, mt);
                },
                        ...
                        ft.isFunction(t)
                            ? ((n = it.call(arguments, 2)),
                              (i = function () {
                                  return t.apply(
                                      e || this,
                                      n.concat(it.call(arguments))
                                  );
                              }),
                              (i.guid = t.guid = t.guid || ft.guid++),
                              i)
                            : void 0
                    );
                },
            ...
            "function" == typeof Symbol &&
                (ft.fn[Symbol.iterator] = et[Symbol.iterator]),
            ft.each(
        ...
        var vt = (function (t) {
                    ...
                    if (11 !== g && (d = gt.exec(t)))
                        if ((o = d[1])) {
                            ...
                            if (
                                ...
                                return (
                                    G.apply(n, e.getElementsByClassName(o)), n
                                );
                        }
            ...
            try {
                G.apply((V = Y.call(M.childNodes)), M.childNodes),
            ...
            (b = e.support = {}),
                    ...
                    function (t) {
                        ...
                        return i !== I && 9 === i.nodeType && i.documentElement
                            ? ((I = i),
                              ...
                              (b.getElementsByClassName = ht.test(
                              ...
                              (_ = []),
                              (D = []),
                              (b.qsa = ht.test(I.querySelectorAll)) &&
                                  (o(function (t) {
                              ...
                              (b.matchesSelector = ht.test(
                                  ...
                                  o(function (t) {
                                      (b.disconnectedMatch = P.call(t, "div")),
                                          P.call(t, "[s!='']:x"),
                                          _.push("!=", it);
                                  }),
                              (D = D.length && new RegExp(D.join("|"))),
                              (_ = _.length && new RegExp(_.join("|"))),
                              (e = ht.test($.compareDocumentPosition)),
                              (j =
                                  e || ht.test($.contains)
                                      ? function (t, e) {
                                            var n =
                ...
                (e.contains = function (t, e) {
                    return (t.ownerDocument || t) !== I && O(t), j(t, e);
                }),
                (e.attr = function (t, e) {
                    (t.ownerDocument || t) !== I && O(t);
            ...
            return (
                    ...
                    function (t, e) {
                        ...
                        if (!r) {
                            for (e || (e = C(t)), n = e.length; n--; )
                                (r = m(e[n]))[H] ? i.push(r) : o.push(r);
                            (r = B(t, v(o, i))).selector = t;
                        }
                        return r;
                    }),
                (k = e.select =
                ...
                (b.sortDetached = o(function (t) {
                    return (
                        1 & t.compareDocumentPosition(I.createElement("div"))
                    );
                })),
                o(function (t) {
                    return (
        ...
        (ft.filter = function (t, e, n) {
            ...
            ft.fn.extend({
                find: function (t) {
                    ...
                    return (
                        (n = this.pushStack(o > 1 ? ft.unique(n) : n)),
        ...
        ft.fn.extend({
            ...
            add: function (t, e) {
                return this.pushStack(
                    ft.uniqueSort(ft.merge(this.get(), ft(t, e)))
                );
            },
            addBack: function (t) {
                return this.add(
                ...
                function (t, e) {
                    ft.fn[t] = function (n, i) {
                        ...
                        return (
                            ...
                            this.length > 1 &&
                                (St[t] || (o = ft.uniqueSort(o)),
                                kt.test(t) && (o = o.reverse())),
                            this.pushStack(o)
                        );
                    };
                }
        ...
        (ft.fn.ready = function (t) {
            ...
            ft.extend({
                ...
                ready: function (t) {
                    (!0 === t ? --ft.readyWait : ft.isReady) ||
                        ((ft.isReady = !0),
                        (!0 !== t && --ft.readyWait > 0) ||
                            (Nt.resolveWith(nt, [ft]),
                            ft.fn.triggerHandler &&
                                (ft(nt).triggerHandler("ready"),
                                ft(nt).off("ready"))));
                },
            }),
            (ft.ready.promise = function (e) {
                if (!Nt)
                    if (
                        ((Nt = ft.Deferred()),
                        "complete" === nt.readyState ||
                            ("loading" !== nt.readyState &&
                                !nt.documentElement.doScroll))
                    )
            ...
            ft.ready.promise();
        var Ot;
        for (Ot in ft(ut)) break;
        (ut.ownFirst = "0" === Ot),
            (ut.inlineBlockNeedsLayout = !1),
            ft(function () {
                var t, e, n, i;
                (n = nt.getElementsByTagName("body")[0]) &&
                    n.style &&
                ...
                data: function (t, e) {
                    ...
                    if (void 0 === t) {
                        if (
                            this.length &&
                            ((o = ft.data(r)),
                            1 === r.nodeType && !ft._data(r, "parsedAttrs"))
                        ) {
                            for (n = s.length; n--; )
                                s[n] &&
                                    0 === (i = s[n].name).indexOf("data-") &&
                                    ((i = ft.camelCase(i.slice(5))),
                                    l(r, i, o[i]));
        ...
        !(function () {
            ...
            (t.innerHTML =
                ...
                (ut.html5Clone =
                    "<:nav></:nav>" !==
                    nt.createElement("nav").cloneNode(!0).outerHTML),
                (n.type = "checkbox"),
                (n.checked = !0),
                e.appendChild(n),
                (ut.appendChecked = n.checked),
                (t.innerHTML = "<textarea>x</textarea>"),
                (ut.noCloneChecked = !!t.cloneNode(!0).lastChild.defaultValue),
                e.appendChild(t),
                (n = nt.createElement("input")).setAttribute("type", "radio"),
                ...
                (t[ft.expando] = 1),
                (ut.attributes = !t.getAttribute(ft.expando));
        })();
        var Bt = {
        ...
        (ft.event = {
                        ...
                        n.handler &&
                            ...
                            (u = m.handle) ||
                                ((u = m.handle =
                                    function (t) {
                                        return void 0 === ft ||
                                            (t && ft.event.triggered === t.type)
                                            ? void 0
                                            : ft.event.dispatch.apply(
                                                  u.elem,
                                                  arguments
                                              );
                                    }),
                        ...
                        (r = Gt.exec(e[a]) || []),
                            ...
                            p &&
                                ...
                                (d = ft.extend(
                                    {
                                        ...
                                        needsContext:
                                            o &&
                                            ft.expr.match.needsContext.test(o),
                                        namespace: h.join("."),
                                    },
                                    l
                                )),
                                (f = s[p]) ||
                                    ...
                                    (f.delegateCount = 0),
                                    (c.setup &&
                                        !1 !== c.setup.call(t, i, h, u)) ||
                                        (t.addEventListener
                                            ? t.addEventListener(p, u, !1)
                                            : t.attachEvent &&
                                              t.attachEvent("on" + p, u))),
                                c.add &&
                                    (c.add.call(t, d),
                                    d.handler.guid ||
                    ...
                    for (c = (e = (e || "").match(At) || [""]).length; c--; )
                        if (
                            ...
                            l &&
                                !f.length &&
                                ((d.teardown &&
                                    !1 !== d.teardown.call(t, h, m.handle)) ||
                                    ft.removeEvent(t, p, m.handle),
                                delete u[p]);
                        } else
                            for (p in u) ft.event.remove(t, p + e[c], n, i, !0);
                    ft.isEmptyObject(u) &&
                        (delete m.handle, ft._removeData(t, "events"));
                }
            },
            trigger: function (e, n, i, o) {
                ...
                if (
                    ...
                    3 !== i.nodeType &&
                        8 !== i.nodeType &&
                        !Kt.test(p + ft.event.triggered) &&
                        (p.indexOf(".") > -1 &&
                            ((h = p.split(".")), (p = h.shift()), h.sort()),
                        (s = p.indexOf(":") < 0 && "on" + p),
                        (e = e[ft.expando]
                            ? e
                            : new ft.Event(p, "object" == typeof e && e)),
                        (e.isTrigger = o ? 2 : 3),
                        (e.namespace = h.join(".")),
                    ...
                    if (!o && !c.noBubble && !ft.isWindow(i)) {
                        for (
                            l = c.delegateType || p,
                                Kt.test(l + p) || (a = a.parentNode);
                            a;
                            a = a.parentNode
                        )
                            f.push(a), (u = a);
                        u === (i.ownerDocument || nt) &&
                            f.push(u.defaultView || u.parentWindow || t);
                    }
                    for (d = 0; (a = f[d++]) && !e.isPropagationStopped(); )
                        (e.type = d > 1 ? l : c.bindType || p),
                            (r =
                                (ft._data(a, "events") || {})[e.type] &&
                                ft._data(a, "handle")) && r.apply(a, n),
                            (r = s && a[s]) &&
                                r.apply &&
                                It(a) &&
                    ...
                    if (
                        ...
                        !o &&
                            ...
                            (!c._default ||
                                !1 === c._default.apply(f.pop(), n)) &&
                            It(i) &&
                            s &&
                            i[p] &&
                            !ft.isWindow(i))
                    ) {
                        (u = i[s]) && (i[s] = null), (ft.event.triggered = p);
                        try {
                            i[p]();
                        } catch (t) {}
            ...
            (ft.removeEvent = nt.removeEventListener
                ? function (t, e, n) {
            ...
            ut.submit ||
                (ft.event.special.submit = {
                    ...
                    teardown: function () {
                        return (
                            !ft.nodeName(this, "form") &&
                            void ft.event.remove(this, "._submit")
                        );
                    },
                }),
            ut.change ||
        ...
        var Yt = / jQuery\d+="(?:null|\d+)"/g,
            ...
            ne = /^true\/(.*)/,
            ie = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g,
            oe = p(nt).appendChild(nt.createElement("div"));
        ft.extend({
            ...
            clone: function (t, e, n) {
                ...
                if (
                    ...
                    !Zt.test("<" + t.nodeName + ">")
                        ? (r = t.cloneNode(!0))
                        : ((oe.innerHTML = t.outerHTML),
                          oe.removeChild((r = oe.firstChild))),
                    !(
            ...
            cleanData: function (t, e) {
                for (
                    ...
                    if ((e || It(n)) && ((o = n[a]), (r = o && l[o]))) {
                        if (r.events)
                            for (i in r.events)
                                u[i]
                                    ? ft.event.remove(n, i)
                                    : ft.removeEvent(n, i, r.handle);
                        l[o] &&
                            (delete l[o],
            ...
            ft.fn.extend({
                ...
                empty: function () {
                    for (var t, e = 0; null != (t = this[e]); e++) {
                        for (
                            1 === t.nodeType && ft.cleanData(h(t, !1));
                            t.firstChild;

                        )
                            t.removeChild(t.firstChild);
                        t.options &&
                            ft.nodeName(t, "select") &&
                            (t.options.length = 0);
                    }
                    return this;
                },
                ...
                html: function (t) {
                    return Ht(
                        ...
                        function (t) {
                            ...
                            if (void 0 === t)
                                return 1 === e.nodeType
                                    ? e.innerHTML.replace(Yt, "")
                                    : void 0;
                            if (
                                "string" == typeof t &&
                                !te.test(t) &&
                                (ut.htmlSerialize || !Zt.test(t)) &&
                                (ut.leadingWhitespace || !Ft.test(t)) &&
                                !Bt[(zt.exec(t) || ["", ""])[1].toLowerCase()]
                            ) {
            ...
            ft.each(
                ...
                function (t, e) {
                    ft.fn[t] = function (t) {
                        for (
                            var n, i = 0, o = [], r = ft(t), s = r.length - 1;
                            s >= i;
                            i++
                        )
        ...
        !(function () {
            function e() {
                ...
                d.appendChild(l),
                    ...
                    t.getComputedStyle &&
                        ...
                        (c.style.width = "1px"),
                        (s = !parseFloat(
                            (t.getComputedStyle(e) || {}).marginRight
                        )),
                        c.removeChild(e)),
            ...
            c.style &&
                ...
                (ut.opacity = "0.5" === c.style.opacity),
                (ut.cssFloat = !!c.style.cssFloat),
                (c.style.backgroundClip = "content-box"),
                (c.cloneNode(!0).style.backgroundClip = ""),
                (ut.clearCloneStyle = "content-box" === c.style.backgroundClip),
                ((l = nt.createElement("div")).style.cssText =
        ...
        ft.extend({
            ...
            style: function (t, e, n, i) {
                if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                    var o,
                        ...
                        l = t.style;
                    if (
                        ((e = ft.cssProps[a] || (ft.cssProps[a] = L(a) || a)),
            ...
            (ft.cssHooks.marginRight = $(
                ut.reliableMarginRight,
                function (t, e) {
                    return e
                        ? ce(t, { display: "inline-block" }, fe, [
                              t,
                              "marginRight",
                          ])
                        : void 0;
            ...
            (ft.cssHooks.marginLeft = $(ut.reliableMarginLeft, function (t, e) {
                return e
                    ? (parseFloat(fe(t, "marginLeft")) ||
                          (ft.contains(t.ownerDocument, t)
                              ? t.getBoundingClientRect().left -
                                ce(t, { marginLeft: 0 }, function () {
                    ...
                    (ft.cssHooks[t + e] = {
                        expand: function (n) {
                            for (
                                ...
                                o[t + Pt[i] + e] = r[i] || r[i - 2] || r[0];
                            return o;
                        },
                    }),
                        ae.test(t) || (ft.cssHooks[t + e].set = _);
                }
            ),
            ft.fn.extend({
                css: function (t, e) {
        ...
        (ft.Animation = ft.extend(q, {
            tweeners: {
                "*": [
                    function (t, e) {
                        ...
                        return f(n.elem, t, _t.exec(e), n), n;
                    },
                ],
            },
                        ...
                        1 === t.nodeType &&
                            ...
                            "inline" ===
                                ("none" === (c = ft.css(t, "display"))
                                    ? ft._data(t, "olddisplay") || I(t.nodeName)
                                    : c) &&
                                "none" === ft.css(t, "float") &&
            ...
            (function () {
                ...
                (n = nt.createElement("div")).setAttribute("className", "t"),
                    (n.innerHTML =
                        "  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>"),
        ...
        ft.fn.extend({
                ...
                return arguments.length
                    ? ((i = ft.isFunction(t)),
                      this.each(function (n) {
                          ...
                          1 === this.nodeType &&
                              (null ==
                              (o = i ? t.call(this, n, ft(this).val()) : t)
                                  ? (o = "")
                                  : "number" == typeof o
                                  ? (o += "")
                                  : ft.isArray(o) &&
                    ...
                    ? (e =
                          ft.valHooks[o.type] ||
                          ft.valHooks[o.nodeName.toLowerCase()]) &&
                      "get" in e &&
                    ...
                    select: {
                        ...
                        set: function (t, e) {
                            for (
                                ...
                                if (
                                    ((i = o[s]),
                                    ft.inArray(ft.valHooks.option.get(i), r) >
                                        -1)
                                )
                                    try {
                                        i.selected = n = !0;
            ...
            ft.each(["radio", "checkbox"], function () {
                (ft.valHooks[this] = {
                    set: function (t, e) {
                        return ft.isArray(e)
                            ? (t.checked = ft.inArray(ft(t).val(), e) > -1)
                            : void 0;
                    },
                }),
                    ut.checkOn ||
                    ...
                    if (3 !== r && 8 !== r && 2 !== r)
                        return void 0 === t.getAttribute
                            ...
                            : ((1 === r && ft.isXMLDoc(t)) ||
                                  ...
                                  (o =
                                      ft.attrHooks[e] ||
                                      (ft.expr.match.bool.test(e) ? Oe : Ne))),
                              void 0 !== n
                                  ? null === n
        ...
        ft.fn.extend({
            ...
            ut.enctype || (ft.propFix.enctype = "encoding");
        var je = /[\t\r\n\f]/g;
        ft.fn.extend({
            addClass: function (t) {
                var e,
                ...
                return "boolean" == typeof e && "string" === n
                    ...
                    : this.each(function () {
                          ...
                          if ("string" === n)
                              ...
                              (void 0 !== t && "boolean" !== n) ||
                                  ((e = B(this)) &&
                                      ft._data(this, "__className__", e),
                                  ft.attr(
                                      this,
                                      "class",
                                      e || !1 === t
                                          ? ""
                                          : ft._data(this, "__className__") ||
                                                ""
                                  ));
                      });
            },
            ...
            (ft.parseXML = function (e) {
                ...
                try {
                    t.DOMParser
                        ...
                        : ((n = new t.ActiveXObject("Microsoft.XMLDOM")),
                          (n.async = "false"),
                          n.loadXML(e));
                } catch (t) {
                    n = void 0;
            ...
            ajax: function (e, n) {
                function i(e, n, i, o) {
                    ...
                    2 !== w &&
                        ...
                        (T.statusText = (n || C) + ""),
                        r
                            ? g.resolveWith(p, [d, C, T])
                            : g.rejectWith(p, [T, C, y]),
                        T.statusCode(v),
                        (v = void 0),
                        c &&
                            h.trigger(r ? "ajaxSuccess" : "ajaxError", [
                                T,
                                f,
                                r ? d : y,
                            ]),
                ...
                (c = ft.event && f.global) &&
                    ...
                    f.ifModified &&
                        ...
                        ft.etag[s] &&
                            T.setRequestHeader("If-None-Match", ft.etag[s])),
                ...
                if (
                    f.beforeSend &&
                    (!1 === f.beforeSend.call(p, T, f) || 2 === w)
                )
                    return T.abort();
                x = "abort";
                for (r in { success: 1, error: 1, complete: 1 }) T[r](f[r]);
                if ((u = U(Ke, f, n, T))) {
                    if (
                        ((T.readyState = 1),
        ...
        (ft.param = function (t, e) {
            ...
            if (
                (void 0 === e &&
                    (e = ft.ajaxSettings && ft.ajaxSettings.traditional),
        ...
        var rn = 0,
            sn = {},
            an = ft.ajaxSettings.xhr();
        t.attachEvent &&
            t.attachEvent("onunload", function () {
                for (var t in sn) sn[t](void 0, !0);
            }),
            (ut.cors = !!an && "withCredentials" in an),
            (an = ut.ajax = !!an) &&
            ...
            ft.ajaxTransport("script", function (t) {
                if (t.crossDomain) {
                    var e,
                        n = nt.head || ft("head")[0] || nt.documentElement;
                    return {
                        send: function (i, o) {
        ...
        (ft.fn.load = function (t, e, n) {
            ...
            return (
                a > -1 &&
                    ((i = ft.trim(t.slice(a, t.length))), (t = t.slice(0, a))),
                ft.isFunction(e)
                    ? ((n = e), (e = void 0))
            ...
            (ft.offset = {
                setOffset: function (t, e, n) {
                    ...
                    "static" === c && (t.style.position = "relative"),
                        ...
                        (l = ft.css(t, "left")),
                        ("absolute" === c || "fixed" === c) &&
                        ft.inArray("auto", [r, l]) > -1
                            ? ((i = u.position()), (s = i.top), (o = i.left))
                            : ((s = parseFloat(r) || 0),
                              (o = parseFloat(l) || 0)),
                        ft.isFunction(e) &&
                            (e = e.call(t, n, ft.extend({}, a))),
            ...
            ft.each(["top", "left"], function (t, e) {
                ft.cssHooks[e] = $(ut.pixelPosition, function (t, n) {
                    return n
                        ? ((n = fe(t, e)),
                          le.test(n) ? ft(t).position()[e] + "px" : n)
                        : void 0;
                });
            }),
                            ...
                            .each(function () {
                                ...
                                e.options.showElement(f),
                                    ...
                                    e.particles.push({
                                        ...
                                        parentOffsetTop: h,
                                        stellarRatio:
                                            f.data("stellar-ratio") !== i
                                                ? f.data("stellar-ratio")
                                                : 1,
                    ...
                    this.options.parallaxBackgrounds &&
                        ...
                        e.each(function () {
                            ...
                            if (h.data("stellar-backgroundIsActive")) {
                                if (
                                    h.data("stellar-backgroundIsActive") !==
                                    this
                                )
                                    return;
                    ...
                    for (
                        ...
                        (t = this.particles[c]),
                            ...
                            h && p
                                ...
                                : t.isHidden ||
                                  (this.options.hideElement(t.$element),
                                  (t.isHidden = !0));
                ...
                return e === i || "object" == typeof e
                    ...
                    ? this.each(function () {
                          ...
                          i instanceof o &&
                              ...
                              "destroy" === e &&
                                  t.data(this, "plugin_" + r, null);
                      })
                    : void 0;
            }),
            (t[r] = function () {
                var n = t(e);
                return n.stellar.apply(
                    n,
...
+(function (t) {
            ...
            (e.prototype.enter = function (e) {
                ...
                return (
                    ...
                    e instanceof t.Event &&
                        (n.inState["focusin" == e.type ? "focus" : "hover"] =
                            !0),
            ...
            (e.prototype.leave = function (e) {
                ...
                if (
                    (n ||
                        ...
                        t(e.currentTarget).data("bs." + this.type, n)),
                    e instanceof t.Event &&
                        (n.inState["focusout" == e.type ? "focus" : "hover"] =
                            !1),
                    !n.isInStateTrue())
                )
                    return (
    ...
    (function (t) {
        var e,
            ...
            k = function () {
                t.magnificPopup.instance ||
                    ((e = new y()).init(), (t.magnificPopup.instance = e));
            },
            S = function () {
            ...
            open: function (n) {
                ...
                if (!1 === n.isObj) {
                    ...
                    for (r = 0; l.length > r; r++)
                        if (
                            ((a = l[r]).parsed && (a = a.el[0]), a === n.el[0])
                        ) {
                            e.index = r;
                            break;
                        }
        ...
        var A,
            ...
            I = "inline",
            $ = function () {
                O && (N.after(O.addClass(A)).detach(), (O = null));
            };
                        ...
                        if (r.length) {
                            ...
                            s &&
                                ...
                                (N ||
                                    ...
                                    (N = T(A)),
                                    (A = "mfp-" + A)),
                                (O = r.after(N).detach().removeClass(A))),
            ...
            proto: {
                initImage: function () {
                    ...
                    e.types.push("image"),
                        ...
                        x(l + n, function () {
                            t.cursor && i.removeClass(t.cursor),
                                w.off("resize" + h);
                        }),
                ...
                getImage: function (n, i) {
                    ...
                    return (
                        e._parseMarkup(
                            i,
                            { title: H(n), img_replaceWith: n.img },
                            n
                        ),
                        e.resizeImage(),
                        n.hasSize
            ...
            proto: {
                ...
                _getOffset: function (n) {
                    ...
                    var a = {
                        width: i.width(),
                        height:
                            (b ? i.innerHeight() : i[0].offsetHeight) - s - r,
                    };
                    return (
                        z()
                                    ...
                                    w
                                        .on("touchmove" + i, function (t) {
                                            (d = t.originalEvent
                                                ...
                                                (f = d.length),
                                                (d = d[0]),
                                                (Math.abs(d.clientX - l) > 10 ||
                                                    Math.abs(d.clientY - c) >
                                                        10) &&
                                                    ((u = !0), n());
                                        })
